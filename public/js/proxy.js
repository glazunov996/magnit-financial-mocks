(function () {
  ...
  const id = "85119cb8-36cf-4cf3-b34e-8f5d730edfb7";
  const connection = {
  ...
  const qMeasures = [
  	{
  		qLabel: "DESCRIPTION7_мера",
  		qLibraryId: "TYNXKp"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт месяц",
  		qLibraryId: "pAAAKDm"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт % от выр. месяц",
  		qLibraryId: "KSZHkg"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Факт п-п % месяц",
  		qLibraryId: "KuJXDh"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Факт п-п месяц",
  	...
  	{
  		qLabel: "ОсновнаяТаблица.vs Бюджет % месяц",
  		qLibraryId: "qngmV"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Бюджет месяц",
  	...
  	{
  		qLabel: "ОсновнаяТаблица.Бюджет % от выр. месяц",
  		qLibraryId: "033ea8ef-dd2f-471e-b7d9-5d3aea280396"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Бюджет месяц",
  		qLibraryId: "ndySRHy"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт п-п % от выр. месяц",
  		qLibraryId: "915a14f9-5dcb-480e-af43-7128bf81e146"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт п-п месяц",
  		qLibraryId: "b8ed1836-0f0b-4003-8d75-5a7aa04ef8cf"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Стрелка месяц",
  		qLibraryId: "kyhNYy"
  	}
  ];
  const qSuppressZero = true;
  const qSuppressMissing = true;
  const qMode = "S";
  ...
  const qMeasures$1 = [
  	...
  	{
  		qLabel: "ОсновнаяТаблица.Факт",
  		qLibraryId: "ECLbEfj"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт % от выр",
  		qLibraryId: "DAyqg"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Факт п-п %",
  		qLibraryId: "HSqstBB"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Факт п-п",
  	...
  	{
  		qLabel: "ОсновнаяТаблица.vs Бюджет %",
  		qLibraryId: "wwgXytH"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.vs Бюджет",
  	...
  	{
  		qLabel: "ОсновнаяТаблица.Бюджет % от выр",
  		qLibraryId: "397074c3-80e4-4281-bee4-a8b0e7509c54"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Бюджет",
  		qLibraryId: "4d00f707-f689-4783-abdf-43e429d6877f"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт п-п % от выр",
  		qLibraryId: "256d39a3-fb65-4a15-98a4-7cc83868531e"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Факт п-п",
  		qLibraryId: "fbc62fa5-924b-4283-836e-884c0009c7c4"
  	},
  	{
  		qLabel: "ОсновнаяТаблица.Стрелка",
  		qLibraryId: "ppxtmzp"
  	}
  ];
  const qSuppressZero$1 = true;
  const qSuppressMissing$1 = true;
  const qMode$1 = "S";
  const qInterColumnSortOrder$1 = [
  ];
  const qStateName$1 = "$";
  var mainTableBlock2 = {
  	qInitialDataFetch: qInitialDataFetch$1,
  	qDimensions: qDimensions$1,
  	qMeasures: qMeasures$1,
  	qSuppressZero: qSuppressZero$1,
  	qSuppressMissing: qSuppressMissing$1,
  	qMode: qMode$1,
  	qInterColumnSortOrder: qInterColumnSortOrder$1,
  	qStateName: qStateName$1
  };

  const qInitialDataFetch$2 = [
  	{
  		qHeight: 600,
  		qWidth: 12
  	}
  ...
  const qDimensions$2 = [
  	...
  	{
  		qLabel: "ПериодИзмерение_id",
  		qLibraryId: "0a2456a6-3694-468d-b28c-778bac05b6cb",
  		qNullSuppression: true,
  		qDef: {
  			qSortCriterias: [
  				{
  ...
  const qMeasures$2 = [
  	...
  	{
  		qLabel: "График.Доля от бюд.",
  		qLibraryId: "DrXbatP"
  	},
  	{
  		qLabel: "График.Доля от бюд. отклонения",
  		qLibraryId: "7acd96fc-20d0-487d-9194-ac0676d2f2d9"
  	},
  	{
  		qLabel: "График.Бюджет",
  		qLibraryId: "RqxUaDd"
  	},
  	{
  		qLabel: "График.Факт п.п.",
  		qLibraryId: "xJQePB"
  	},
  	{
  		qLabel: "График.Доля от факта п.п.",
  		qLibraryId: "mzsWEjJ"
  	},
  	{
  		qLabel: "График.Доля от факта п.п. отклонения",
  		qLibraryId: "dee4b704-766e-4182-a84d-a3635562ca1b"
  	}
  ];
  const qSuppressZero$2 = true;
  const qSuppressMissing$2 = true;
  const qMode$2 = "S";
  const qInterColumnSortOrder$2 = [
  ];
  const qStateName$2 = "$";
  var chartsMainTable = {
  	qInitialDataFetch: qInitialDataFetch$2,
  	qDimensions: qDimensions$2,
  	qMeasures: qMeasures$2,
  	qSuppressZero: qSuppressZero$2,
  	qSuppressMissing: qSuppressMissing$2,
  	qMode: qMode$2,
  	qInterColumnSortOrder: qInterColumnSortOrder$2,
  	qStateName: qStateName$2
  };

  var datesRequestConfig = [
  	"$",
  	"State2"
  ];
  ...
  function qlikRequestDatesUpdate(app, date, datePoP, columnPrecision) {
  ...
  async function requestFilterShop(app, areaConfig) {
  ...
  function qlikRequestFilterLFLState(app, resolve, object) {
    ...
    const config = { rows: 10000 };
    const request = app.field(key).getData(config).OnData;
  ...
  async function qlikRequestFilterShop(app) {
    return await requestFilterShop(app)
      .then( async ({reply}) => {
  ...
  async function qlikRequestFilterState(app) {
    ...
    processLFL(data);   
    const shop = await qlikRequestFilterShop(app);
    data[4].data = shop;
    return data;
  }

  function qlikRequestFilterUpdate(promise, key, value, app) {
    return promise.then(() => (
      new Promise((resolve) => {
  ...
  function qlikRequestFiltersUpdate(app, conditions) {
  ...
  const qSuppressZero$3 = false;
  const qSuppressMissing$3 = false;
  const qMode$3 = "S";
  const qInterColumnSortOrder$3 = [
  ];
  const qStateName$3 = "$";
  var precisionRequestConfig = {
  	qInitialDataFetch: qInitialDataFetch$3,
  	qDimensions: qDimensions$3,
  	qMeasures: qMeasures$3,
  	qSuppressZero: qSuppressZero$3,
  	qSuppressMissing: qSuppressMissing$3,
  	qMode: qMode$3,
  	qInterColumnSortOrder: qInterColumnSortOrder$3,
  	qStateName: qStateName$3
  };
  ...
  function qlikRequestPrecisionUpdate(name, app, value) {
    return app.variable.setStringValue(name, `${value}`);
  }

  function qlikRequestPrecisionsUpdate(app, precisions) {
    console.log("PRECISIONS", precisions);
    return Promise.all(['vPeriod', 'vPeriodDiagram', 'vAbsFlag', 'vPeriodUnit1'].map((name, index) => qlikRequestPrecisionUpdate(name, app, precisions[index])));
  }

  async function requestFormatDeviationsCountBlock1_Month(app){
  ...
  async function requestFormatDeviationsCountBlock1_Quarter(app){
    return new Promise( (resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFormatDeviationsCountBlock1_Year(app){
    return new Promise( (resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFormatDeviationsCountBlock1_Month_Absolute(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
          "qInitialDataFetch": [
              {
  ...
  async function requestFormatDeviationsCountBlock1_Quarter_Absolute(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
          "qInitialDataFetch": [
              {
  ...
  async function requestFormatDeviationsCountBlock1_Year_Absolute(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
          "qInitialDataFetch": [
              {
  ...
  async function requestFormatDeviationsCountBlock2_Quarter(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
      "qInitialDataFetch": [
          {
  ...
  async function requestFormatDeviationsCountBlock2_Year(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
      "qInitialDataFetch": [
          {
  ...
  async function requestFormatDeviationsCountBlock2_Quarter_Absolute(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
          "qInitialDataFetch": [
              {
  ...
  async function requestFormatDeviationsCountBlock2_Year_Absolute(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
          "qInitialDataFetch": [
              {
  ...
  async function requestRegionDeviationsCountBlock1_Month(app){
    return new Promise( ( resolve, reject) => {
      app.createCube({
      "qInitialDataFetch": [
          {
  ...
  async function requestRegionDeviationsCountBlock1_Quarter(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock1_Year(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock1_Month_Absolute(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock1_Quarter_Absolute(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock1_Year_Absolute(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock2_Quarter(app){
    return new Promise( (resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock2_Year(app){
    return new Promise( (resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock2_Quarter_Absolute(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestRegionDeviationsCountBlock2_Year_Absolute(app){
    return new Promise( ( resolve, reject) => {
        app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function callApi(func, name) {
  ...
  async function qlikRequestMainTableBlock(app) {
  ...
  async function qlickRequestChartsMainTable(app) {
  ...
  function processChartsMainTable(reply) {
    let coppyedHeaders = [];
    ...
    let coppyedRows = lodash.cloneDeep(reply.qHyperCube.qDataPages[0].qMatrix);
  ...
  async function qlikRequestFinancialOverviewData(app, filters, type) {  
  ...
  async function qlikRequestFinancialOverview(app, filters, type) {
    if (type === 'meta') {
  ...
  const qMeasures$4 = [
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.Факт % от выр месяц",
  		qLibraryId: "QWTG"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.vs Факт п-п % месяц",
  		qLibraryId: "DtfFZ"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.vs Бюджет % месяц",
  		qLibraryId: "cmtTzPK"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.Стрелка месяц",
  		qLibraryId: "dmupPb"
  	}
  ];
  const qSuppressZero$4 = true;
  const qSuppressMissing$4 = true;
  const qMode$4 = "S";
  const qInterColumnSortOrder$4 = [
  ];
  const qStateName$4 = "$";
  var formatSlicesBlock1 = {
  	qInitialDataFetch: qInitialDataFetch$4,
  	qDimensions: qDimensions$4,
  	qMeasures: qMeasures$4,
  	qSuppressZero: qSuppressZero$4,
  	qSuppressMissing: qSuppressMissing$4,
  	qMode: qMode$4,
  	qInterColumnSortOrder: qInterColumnSortOrder$4,
  	qStateName: qStateName$4
  };

  const qInitialDataFetch$5 = [
  	{
  		qHeight: 20,
  		qWidth: 5
  	}
  ...
  const qMeasures$5 = [
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.Факт % от выр",
  		qLibraryId: "tdpLeV"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.vs Факт п-п %",
  		qLibraryId: "mfkwrV"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.vs Бюджет %",
  		qLibraryId: "yacVSmJ"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоФорматам.Стрелка",
  		qLibraryId: "AYqkjZU"
  	}
  ];
  const qSuppressZero$5 = true;
  const qSuppressMissing$5 = true;
  const qMode$5 = "S";
  const qInterColumnSortOrder$5 = [
  ];
  const qStateName$5 = "$";
  var formatSlicesBlock2 = {
  	qInitialDataFetch: qInitialDataFetch$5,
  	qDimensions: qDimensions$5,
  	qMeasures: qMeasures$5,
  	qSuppressZero: qSuppressZero$5,
  	qSuppressMissing: qSuppressMissing$5,
  	qMode: qMode$5,
  	qInterColumnSortOrder: qInterColumnSortOrder$5,
  	qStateName: qStateName$5
  };

  const qInitialDataFetch$6 = [
  	{
  		qHeight: 20,
  		qWidth: 5
  	}
  ...
  const qMeasures$6 = [
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.Факт % от выр месяц",
  		qLibraryId: "WEwPT"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.vs Факт п-п % месяц",
  		qLibraryId: "JBzP"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.vs Бюджет % месяц",
  		qLibraryId: "ZguZQP"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.Стрелка месяц",
  		qLibraryId: "CXTWLC"
  	}
  ];
  const qSuppressZero$6 = true;
  const qSuppressMissing$6 = true;
  const qMode$6 = "S";
  const qInterColumnSortOrder$6 = [
  ];
  const qStateName$6 = "$";
  var regionSlicesBlock1 = {
  	qInitialDataFetch: qInitialDataFetch$6,
  	qDimensions: qDimensions$6,
  	qMeasures: qMeasures$6,
  	qSuppressZero: qSuppressZero$6,
  	qSuppressMissing: qSuppressMissing$6,
  	qMode: qMode$6,
  	qInterColumnSortOrder: qInterColumnSortOrder$6,
  	qStateName: qStateName$6
  };

  const qInitialDataFetch$7 = [
  	{
  		qHeight: 20,
  		qWidth: 5
  	}
  ...
  const qMeasures$7 = [
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.Факт % от выр",
  		qLibraryId: "pHxRHve"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.vs Факт п-п %",
  		qLibraryId: "hsxdBx"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.vs Бюджет %",
  		qLibraryId: "djMLRy"
  	},
  	{
  		qLabel: "ТаблОтклоненияПоОкругам.Стрелка",
  		qLibraryId: "rdJ"
  	}
  ];
  const qSuppressZero$7 = true;
  const qSuppressMissing$7 = true;
  const qMode$7 = "S";
  const qInterColumnSortOrder$7 = [
  ];
  const qStateName$7 = "$";
  var regionSlicesBlock2 = {
  	qInitialDataFetch: qInitialDataFetch$7,
  	qDimensions: qDimensions$7,
  	qMeasures: qMeasures$7,
  	qSuppressZero: qSuppressZero$7,
  	qSuppressMissing: qSuppressMissing$7,
  	qMode: qMode$7,
  	qInterColumnSortOrder: qInterColumnSortOrder$7,
  	qStateName: qStateName$7
  };

  const qInitialDataFetch$8 = [
  	{
  		qHeight: 1000,
  		qWidth: 6
  	}
  ...
  const qMeasures$8 = [
  	{
  		qLabel: "ГрафикПоОкругам.vs Факт п-п",
  		qLibraryId: "4ab16dc1-3061-4817-9433-a7a4a4a58bc1"
  	},
  	{
  		qLabel: "ГрафикПоОкругам.vs Бюждет",
  		qLibraryId: "brenF"
  	}
  ];
  const qSuppressZero$8 = false;
  const qSuppressMissing$8 = false;
  const qMode$8 = "S";
  const qInterColumnSortOrder$8 = [
  ];
  const qStateName$8 = "$";
  var chartRegionSlices = {
  	qInitialDataFetch: qInitialDataFetch$8,
  	qDimensions: qDimensions$8,
  	qMeasures: qMeasures$8,
  	qSuppressZero: qSuppressZero$8,
  	qSuppressMissing: qSuppressMissing$8,
  	qMode: qMode$8,
  	qInterColumnSortOrder: qInterColumnSortOrder$8,
  	qStateName: qStateName$8
  };

  const qInitialDataFetch$9 = [
  	{
  		qHeight: 1000,
  		qWidth: 9
  	}
  ...
  const qMeasures$9 = [
  	{
  		qLabel: "ГрафикПоФорматам.vs Факт п-п",
  		qLibraryId: "581c5e77-56d6-4c2d-a217-001798b2ea19"
  	},
  	{
  		qLabel: "ГрафикПоФорматам.vs Бюждет",
  		qLibraryId: "59428fa3-4712-4ffa-95b6-694d299e3038"
  	},
  	{
  		qLabel: "ГрафикПоФорматам.vs Факт п-п_выр_%",
  		qLibraryId: "1b563a84-5857-41ca-b855-428a8852bf1a"
  	},
  	{
  		qLabel: "ГрафикПоФорматам.vs Бюждет_выр_%",
  		qLibraryId: "d870f634-2d86-4637-9c2d-4d91894bee49"
  	},
  	{
  		qLabel: "МераДляСбросаПериодаПриВыбореLFL",
  		qLibraryId: "bWVDN"
  	}
  ];
  const qSuppressZero$9 = true;
  const qSuppressMissing$9 = true;
  const qMode$9 = "S";
  const qInterColumnSortOrder$9 = [
  ];
  const qStateName$9 = "$";
  var chartFormatSlices = {
  	qInitialDataFetch: qInitialDataFetch$9,
  	qDimensions: qDimensions$9,
  	qMeasures: qMeasures$9,
  	qSuppressZero: qSuppressZero$9,
  	qSuppressMissing: qSuppressMissing$9,
  	qMode: qMode$9,
  	qInterColumnSortOrder: qInterColumnSortOrder$9,
  	qStateName: qStateName$9
  };

  const qInitialDataFetch$a = [
  	{
  		qHeight: 700,
  		qWidth: 12
  	}
  ...
  const qSuppressZero$a = true;
  const qSuppressMissing$a = true;
  const qMode$a = "S";
  const qInterColumnSortOrder$a = [
  ];
  const qStateName$a = "$";
  var chartSliceFromMainTable = {
  	qInitialDataFetch: qInitialDataFetch$a,
  	qDimensions: qDimensions$a,
  	qMeasures: qMeasures$a,
  	qSuppressZero: qSuppressZero$a,
  	qSuppressMissing: qSuppressMissing$a,
  	qMode: qMode$a,
  	qInterColumnSortOrder: qInterColumnSortOrder$a,
  	qStateName: qStateName$a
  };
  ...
  function processChartsSlices(reply) {
    ...
    let coppyedRows = lodash.cloneDeep(reply.qHyperCube.qDataPages[0].qMatrix);
    let DATA = parseRowsDeviationDetailForCharts(coppyedHeaders, coppyedRows);
    return DATA
  }
  ...
  async function qlikUpdateFilters$1(app, { conditions, date, datePoP, columnPrecision, datePrecision, dynamics, units }) {
  ...
  async function qlikRequestFinancialOverviewData$1(app, filters, id, type) {
    if (type === 'meta') {
      const tasks = [
        callApi(qlikRequestDates(app), "qlikRequestDates"),
        callApi(qlikRequestFilterState(app), "qlikRequestFilterState"),
  ...
  async function qlikRequestFinancialSlices(app, indicator, filters, type) {
    ...
    if (type === 'meta') {
      ...
      if (filters && !filters.initial && !filters.noUpdate) await callApi(qlikUpdateFilters$1(app, filters), "qlikUpdateFilters");
    }
    const slices = await qlikRequestFinancialOverviewData$1(app, filters, id, type);
    console.log("SLICES FINISHED", type);
    return slices;
  }

  const qInitialDataFetch$b = [
  	{
  		qHeight: 200,
  		qWidth: 4
  	}
  ...
  const qMeasures$b = [
  	{
  		qLabel: "Мосты.Факт % от выр. месяц",
  		qLibraryId: "TwLPKh"
  	},
  	{
  		qLabel: "Мосты.Бюджет % от выр. месяц",
  		qLibraryId: "XuHYhfB"
  	}
  ];
  const qSuppressZero$b = true;
  const qSuppressMissing$b = true;
  const qMode$b = "S";
  const qInterColumnSortOrder$b = [
  ];
  const qStateName$b = "$";
  var factorsDataBlock1 = {
  	qInitialDataFetch: qInitialDataFetch$b,
  	qDimensions: qDimensions$b,
  	qMeasures: qMeasures$b,
  	qSuppressZero: qSuppressZero$b,
  	qSuppressMissing: qSuppressMissing$b,
  	qMode: qMode$b,
  	qInterColumnSortOrder: qInterColumnSortOrder$b,
  	qStateName: qStateName$b
  };

  const qInitialDataFetch$c = [
  	{
  		qHeight: 200,
  		qWidth: 4
  	}
  ...
  const qMeasures$c = [
  	{
  		qLabel: "Мосты.Факт % от выр.",
  		qLibraryId: "fnds"
  	},
  	{
  		qLabel: "Мосты.Бюджет % от выр.",
  		qLibraryId: "hYexseW"
  	}
  ];
  const qSuppressZero$c = true;
  const qSuppressMissing$c = true;
  const qMode$c = "S";
  const qInterColumnSortOrder$c = [
  ];
  const qStateName$c = "$";
  var factorsDataBlock2 = {
  	qInitialDataFetch: qInitialDataFetch$c,
  	qDimensions: qDimensions$c,
  	qMeasures: qMeasures$c,
  	qSuppressZero: qSuppressZero$c,
  	qSuppressMissing: qSuppressMissing$c,
  	qMode: qMode$c,
  	qInterColumnSortOrder: qInterColumnSortOrder$c,
  	qStateName: qStateName$c
  };

  const qInitialDataFetch$d = [
  	{
  		qHeight: 20,
  		qWidth: 6
  	}
  ...
  const qMeasures$d = [
  	{
  		qLabel: "МостыИтоги.Факт п-п % от выр. месяц",
  		qLibraryId: "UbmdGRk"
  	},
  	{
  		qLabel: "МостыИтоги.Бюджет % от выр. месяц",
  		qLibraryId: "wbBtd"
  	},
  	{
  		qLabel: "МостыИтоги.Факт % от выр. месяц",
  		qLibraryId: "gjAvD"
  	},
  	{
  		qLabel: "МостыИтоги.тп vs Бюджет месяц",
  		qLibraryId: "89764093-4562-4e72-a611-0587a836af1c"
  	},
  	{
  		qLabel: "МостыИтоги.тп vs пп месяц",
  		qLibraryId: "GJPya"
  	}
  ];
  const qSuppressZero$d = true;
  const qSuppressMissing$d = true;
  const qMode$d = "S";
  const qInterColumnSortOrder$d = [
  ];
  const qStateName$d = "$";
  var factorsResultsBlock1 = {
  	qInitialDataFetch: qInitialDataFetch$d,
  	qDimensions: qDimensions$d,
  	qMeasures: qMeasures$d,
  	qSuppressZero: qSuppressZero$d,
  	qSuppressMissing: qSuppressMissing$d,
  	qMode: qMode$d,
  	qInterColumnSortOrder: qInterColumnSortOrder$d,
  	qStateName: qStateName$d
  };

  const qInitialDataFetch$e = [
  	{
  		qHeight: 20,
  		qWidth: 6
  	}
  ...
  const qMeasures$e = [
  	{
  		qLabel: "МостыИтоги.Факт п-п % от выр.",
  		qLibraryId: "DCQ"
  	},
  	{
  		qLabel: "МостыИтоги.Бюджет % от выр.",
  		qLibraryId: "LrsJbZ"
  	},
  	{
  		qLabel: "МостыИтоги.Факт % от выр.",
  		qLibraryId: "PgVssJT"
  	},
  	{
  		qLabel: "МостыИтоги.тп vs Бюджет",
  		qLibraryId: "30384010-8e84-455c-830f-0b78125d5c66"
  	},
  	{
  		qLabel: "МостыИтоги.тп vs пп",
  		qLibraryId: "8677bd8a-84a2-47cf-a995-00f77ec819af"
  	}
  ];
  const qSuppressZero$e = true;
  const qSuppressMissing$e = true;
  const qMode$e = "S";
  const qInterColumnSortOrder$e = [
  ];
  const qStateName$e = "$";
  var factorsResultsBlock2 = {
  	qInitialDataFetch: qInitialDataFetch$e,
  	qDimensions: qDimensions$e,
  	qMeasures: qMeasures$e,
  	qSuppressZero: qSuppressZero$e,
  	qSuppressMissing: qSuppressMissing$e,
  	qMode: qMode$e,
  	qInterColumnSortOrder: qInterColumnSortOrder$e,
  	qStateName: qStateName$e
  };

  async function requestFactorsDataEBITDABlock1(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFactorsDataEBITDABlock2(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFactorsDataNetProfitBlock1(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFactorsDataNetProfitBlock2(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFactorsDataGrossRevenueBlock1(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  async function requestFactorsDataGrossRevenueBlock2(app){
    return new Promise( (resolve, reject) => {
      app.createCube({
        "qInitialDataFetch": [
            {
  ...
  const INDICATORS$1 = financialIndicators.reduce((result, group) => [...result, ...group.indicators], []);
  ...
  async function qlikUpdateFilters$2(app, { conditions, date, datePoP, columnPrecision, datePrecision, dynamics, units }) {
    await qlikRequestDatesUpdate(app, date, datePoP, datePrecision);
    await qlikRequestFiltersUpdate(app, conditions);
    await qlikRequestPrecisionsUpdate(app, [columnPrecision, dynamics, units, datePrecision]);
    return Promise.resolve();
  ...
  async function qlikRequestFinancialFactorsData(app, id, type) {
    if (type === 'meta') {
      const tasks = [
        callApi(qlikRequestDates(app), "qlikRequestDates"),
        callApi(qlikRequestFilterState(app), "qlikRequestFilterState"),
  ...
  function qlikSelectIndicator$1(app, value) {
    return app.field(config.indicators).clear().then(() => app.field(config.indicators).selectValues([value], true, true));
  }

  async function qlikRequestFinancialFactors(app, indicator, filters, type) {
    const foundIndicator = findIndicator$1(indicator);
    const { label, id } = foundIndicator;
    console.log("FACTORS STARTED", label, id, foundIndicator);
    if (type === 'meta') {
      if (filters && !filters.fetch) await callApi(qlikSelectIndicator$1(app, label), "qlikSelectIndicator");
      if (filters && !filters.initial && !filters.noUpdate) await callApi(qlikUpdateFilters$2(app, filters), "qlikUpdateFilters");
    }
  ...
  const qSuppressZero$f = false;
  const qSuppressMissing$f = false;
  const qMode$f = "S";
  const qInterColumnSortOrder$f = [
  ];
  const qStateName$f = "$";
  var exportRequestConfig = {
  	qInitialDataFetch: qInitialDataFetch$f,
  	qDimensions: qDimensions$f,
  	qMeasures: qMeasures$f,
  	qSuppressZero: qSuppressZero$f,
  	qSuppressMissing: qSuppressMissing$f,
  	qMode: qMode$f,
  	qInterColumnSortOrder: qInterColumnSortOrder$f,
  	qStateName: qStateName$f
  };
  ...
  async function qlikRequestFinancialExportData(app) {
  ...
  async function qlikRequestFinancialExport(app, indicators, slices, expressions, filters, units, prevFilters) {
  ...
  function qlikRequestOperationalComparisons() {

  }

  function qlikRequestOperationalExport() {
  ...
  function qlikRequestComparisons(indicator, filters) {
    return qlikRequestOperationalComparisons();
  }
  ...
  function qlikRequestDetail(dashboard, indicator, detail, filters, type) {
    ...
    else if (detail === 'comparisons') return qlikRequestComparisons();
  ...
  function qlikRequestExportData$1(dashboard) {
    return qlikRequestFinancialExportData(app);
  }

  function qlikRequest({ dashboard, indicator, detail, filters, type }) {
    if (detail) return qlikRequestDetail(dashboard, indicator, detail, filters, type);
    else if (indicator && indicator === 'export') return qlikRequestExportData$1();
  ...
  function qlikRequestExport({ dashboard, indicators, slices, expressions, filters, units, prevFilters }) {
    if (dashboard === 'financial') return qlikRequestFinancialExport(app, indicators, slices, expressions, filters, units, prevFilters);
    return qlikRequestOperationalExport();
  }
